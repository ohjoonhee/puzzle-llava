...
def extract_answer_from_output(output):
    ...
    try:
        answer = output.split('The answer is ')[1].split('.')[0]
    except IndexError:
        answer = output
...
def infer_model(args):
    ...
    with open("playground/data/pswap_annotations_val_10k_processed.json", 'r') as f:
        val_items = json.load(f)
    IMAGE_BASE_DIR = "playground/data/pswap_images_val_10k"
    ...
    print(f"Accuracy: {cnt_correct}/{len(val_items)}")
    
if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    model_path = "checkpoints/llava-v1.5-7b-r8-merge-llr"
